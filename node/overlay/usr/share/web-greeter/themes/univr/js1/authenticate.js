export class Authenticate {
    constructor() {
        console.log("Autenticazione - costruttore");
    ...
    setForm() {
        console.log("Autenticazione - set form");
        if (!this._form)
            return;
    ...
    // }
    showMessage(msg) {
        console.log("Autenticazione - showMessage");
    ...
    hideMessage() {
        console.log("Autenticazione - hideMessage");
        const message = document.querySelector("#auth-message");
        message?.classList.add("hide");
    }
    async _authenticationDone() {
        console.log("Autenticazione - _authenticationDone");
    ...
    setSignalHandler() {
        console.log("Autenticazione - setSignalHandler");
    ...
    init() {
        console.log("Autenticazione - init");
